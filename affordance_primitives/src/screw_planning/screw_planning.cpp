...
bool decodeConstraintsMsg(
  const moveit_msgs::msg::Constraints & msg, ScrewAxis & screw_axis, Eigen::Isometry3d & start_pose,
  ...
  moveit_msgs::msg::Constraints & msg)
{
  ...
  geometry_msgs::msg::Pose screw_pose;
  ...
  geometry_msgs::msg::Pose start_pose_msg = tf2::toMsg(start_pose);

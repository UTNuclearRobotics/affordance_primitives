...
ExampleParameterManager::setParameters(const affordance_primitives::APRobotParameter& params)
{
...
PLUGINLIB_EXPORT_CLASS(ap_examples::ExampleParameterManager, affordance_primitives::ParameterManager)
